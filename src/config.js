...
const incompatible = {
  ...
  "blue camo": ["Logo 1 Black", "black 5 point star", "white 5 point star", "basketball jersey", "red button up", "red plaid", "left if star", "left mf star", "left pf start", "left rf star", "right if star", "right mf star", "right pf star", "right rf star"],
  "red camo": ["Logo 1 Black", "Logo 2 Black", "black 6 point star", "white 6 point start", "blue button up", "blue plaid", "rollin 60s"],
  "blue bandana": ["black 5 point star", "white 5 point star", "basketball jersey", "red button up", "red plaid", "left if star", "left mf star", "left pf start", "left rf star", "right if star", "right mf star", "right pf star", "right rf star"],
  ...
  "black blue aura": ["red bandana", "red camo", "black 5 point star", "white 5 point star", "basketball jersey", "red button up", "red plaid", "left if star", "left mf star", "left pf start", "left rf star", "right if star", "right mf star", "right pf star", "right rf star"],
  "grey blue aura": ["red bandana", "red camo", "black 5 point star", "white 5 point star", "basketball jersey", "red button up", "red plaid", "left if star", "left mf star", "left pf start", "left rf star", "right if star", "right mf star", "right pf star", "right rf star"],
  "black 5 point star": ["blue button up", "blue plaid", "rollin 60s"],
  "white 5 point star": ["blue button up", "blue plaid", "rollin 60s"],
  "black 6 point star": ["red button up", "red plaid", "basketball jersey", "left if star", "left mf star", "left pf start", "left rf star", "right if star", "right mf star", "right pf star", "right rf star"],
  "white 6 point star": ["red button up", "red plaid", "basketball jersey", "left if star", "left mf star", "left pf start", "left rf star", "right if star", "right mf star", "right pf star", "right rf star"],
  "blue button up": ["left if star", "left mf star", "left pf start", "left rf star", "right if star", "right mf star", "right pf star", "right rf star"],
  "blue plaid": ["left if star", "left mf star", "left pf start", "left rf star", "right if star", "right mf star", "right pf star", "right rf star"],
  "red button up": ["rollin 60s"],
  "red plaid": ["rollin 60s"],
  "basketball jersey": ["rollin 60s"],
  "black OG logo": ["OG logo"],
  "white OG logo": ["OG logo"],
  "black diamond": ["diamond"],
  "white diamond": ["diamond"],
  "rollin 60s": ["left if star", "left mf star", "left pf start", "left rf star", "right if star", "right mf star", "right pf star", "right rf star"],
};
...
const traitValueOverrides = {
  ...
  "black skull and bones" : "skull n bones",
  "black Solana logo" : "Solana",
  ...
  "white skull and bones" : "skull n bones",
  "white Solana logo" : "Solana",
